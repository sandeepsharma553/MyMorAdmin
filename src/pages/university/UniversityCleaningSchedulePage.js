...
export default function UniversityCleaningSchedulePage(props) {
  ...
  const handleAdd = async (e) => {
    ...
    try {
      if (editingData) {
        ...
        if (!docSnap.exists()) {
          toast.warning("Cleaning schedule does not exist! Cannot update.");
          return;
        }
              ...
              <tr className="border-t border-gray-200">
                <th className="px-6 pb-3">
                  <input
                    ...
                    onChange={(e) =>
                      setFilterDebounced("roomtype", e.target.value)
                    }
                  />
                </th>
                <th className="px-6 pb-3">
        ...
        <div className="fixed inset-0 bg-black bg-opacity-40 flex items-center justify-center z-20">
          <div className="bg-white w-full max-w-2xl max-h-[90vh] overflow-y-auto p-6 rounded-lg shadow-lg">
            <h2 className="text-xl font-bold mb-4">
              {editingData
                ? "Edit University Cleaning Schedule"
                : "Add University Cleaning Schedule"}
            </h2>
        ...
        <div className="fixed inset-0 bg-black bg-opacity-40 flex items-center justify-center z-50">
          <div className="bg-white p-6 rounded-lg w-80 shadow-lg">
            <h2 className="text-xl font-semibold mb-4 text-red-600">
              Delete University Cleaning Schedule
            </h2>
            <p className="mb-4">
