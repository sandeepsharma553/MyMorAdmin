// src/pages/UniversityDiningMenuPage.jsx
...
export default function UniversityDiningMenuPage(props) {
  ...
  const getList = async (dateStr, mode) => {
    ...
    try {
      ...
      const weekMenus = querySnapshot.docs.map((d) => ({
        id: d.id,
        ...d.data(),
      }));
        ...
        <div className="fixed inset-0 bg-black bg-opacity-40 flex items-center justify-center z-50">
          <div className="bg-white p-6 rounded-lg w-80 shadow-lg">
            ...
            <p className="mb-4">
              ...
              <strong>
                {deleteData?.date} — {deleteData?.day}
              </strong>
              ?
            </p>
