...
const EventSettingPage = () => {
  return (
    <main className="flex-1 p-6 bg-gray-100 overflow-auto">
      <h1 className="text-2xl font-semibold mb-4">Event Setting</h1>

      {/* Payment Types (existing collection name kept to match your DB) */}
      <SimpleCrudSection
        title="Payment Types"
        collectionName="punliceventpaymenttype"
        addButtonLabel="+ Add Payment Type"
        // duplicate check by uid (same as your original)
        duplicateWhere={(uid) => [where("uid", "==", uid)]}
      />
      ...
      <SimpleCrudSection
        ...
        collectionName="publiceventcategory"
        addButtonLabel="+ Add Event Category"
        duplicateWhere={(uid) => [where("uid", "==", uid)]}
      />
